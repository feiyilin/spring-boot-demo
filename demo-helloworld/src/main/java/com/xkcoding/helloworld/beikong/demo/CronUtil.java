...
import com.xkcoding.helloworld.beikong.demo.dto.TaskScheduleModel;
...
//      Date startTime = taskScheduleModel.getScheduleStartTime();   
    ...
    public static void main(String[] args) {
        ...
        TaskScheduleModel taskScheduleModel3 = new TaskScheduleModel();
        Integer[] dayOfWeek = new Integer[2];
        dayOfWeek[0] = 0;
        dayOfWeek[1] = 1;
        taskScheduleModel3.setDayOfWeeks(dayOfWeek);
        taskScheduleModel3.setHour(15);
        taskScheduleModel3.setMinute(20);
        taskScheduleModel3.setSecond(0);
        taskScheduleModel3.setJobType(3);
        System.out.println(createCronExpression(taskScheduleModel3) + ":" + createDescription(taskScheduleModel3));
